...
const rectPercent = [80.5, 74.5, 68.5];
const rectFrame4Percent = [37, 33, 28];

const rectAnimation = {
  yPercent: (i) => rectPercent[i],
  duration: 0.7,
  stagger: 0.13,
  ease: "power3.out",
};
const rectFrame4Animation = {
  ...rectAnimation,
  yPercent: (i) => rectFrame4Percent[i],
};
const hideY = {
  opacity: 0,
  y: 12,
...
tl.from("#frame-2 .rect-full", { ...rectAnimation, yPercent: -100 });
...
tl.from("#frame-3 .rect-full", { ...rectAnimation, yPercent: -100 });
...
tl.to("#frame-4 .rect-full", rectFrame4Animation, "-=0.5");
tl.from("#txt04", hideY, "-=1.5");
